                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">B2B-Geräte</h4>
                                                                    <p class="card-subtitle card-subtitle-dash">Sie haben {{$allB2bDevices}}+ Geräte
                                                                         </p>
                                                                </div>
                                                                <div>
                                                                    <a href="adminAllB2bDevices" class="btn btn-primary btn-lg text-white mb-0 me-0" >Alle B2B-Geräte</a>
                                                                </div>
                                                            </div>
...
{{--                                                                    b2b overview--}}
                                                                    ...
                                                                    @if($B2bOverview->isNotEmpty())
                                                                        <?php

                                                                        for($i=0; $i<sizeof($b2bPartners); $i++){
                                                                            echo "<tbody>";
                                                                            echo "<tr>";
                                                                            echo "<td>";
                                                                            ...
                                                                            echo '   <td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                <a href="adminB2bDevice/'.$B2bOverview[$i]->id.'" class="text-decoration-none"><h6>'.$B2bOverview[$i]->model.'</h6></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                 <h6>'.$B2bOverview[$i]->created_at.'</h6>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ';
                                                                            if(isset($B2bOverview[$i]->tech)){
                                                                                echo '<td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                 <h6>'.$B2bOverview[$i]->tech.'</h6>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>';
                                                                            }else{
                                                                            ...
                                                                            }elseif($B2bOverview[$i]->status == "finished"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                            ...
                                                                            }elseif($B2bOverview[$i]->status == "sent"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                                             <h6 class="badge badge-opacity-primary me-3">gesendet</h6>
                                                                                    </td>
                                                                                    </div>';
                                                                            }elseif($B2bOverview[$i]->status == "wait4Parts"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                                ...
                                                                <div>
                                                                    <a class="btn btn-primary btn-lg text-white mb-0 me-0" href="adminAllB2cDevices">Alle B2C-Geräte</a>
                                                                </div>
                                                            </div>
                                                            <div class="table-responsive  mt-1">
                                                                <table class="table select-table">
...
{{--                                                                    b2b overview--}}
                                                                    ...
                                                                    @if($B2cOverview->isNotEmpty())
                                                                        @foreach($B2cOverview as $b2cDevice)
                                                                                <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                 <h6><a class="text-decoration-none text-dark" href="adminPanel/Device/{{$b2cDevice->id}}}"> {{$b2cDevice->model}}</a></h6>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                            ...
                                                                            @if($tasks->isNotEmpty())
                                                                                @foreach($tasks as $task)
                                                                                    <li class="d-block">
                                                                                        ...
                                                                                        <div onclick="editTodo({{$task->id}}, '{{$task->message}}')" class="form-check w-100">
                                                                                            <label class="form-check-label">
