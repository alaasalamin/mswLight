                                                                    ...
                                                                    @if($B2bDevices->isNotEmpty())
                                                                        ...
                                                                        for($i=0; $i<sizeof($b2bPartners); $i++){
                                                                            ...
                                                                            echo '   <td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                               <a href="adminB2bDevice/'.$B2bDevices[$i]->id.'" class="text-decoration-none"> <h6>'.$B2bDevices[$i]->model.'</h6></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                 <h6>'.$B2bDevices[$i]->created_at.'</h6>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ';
                                                                            if(isset($B2bDevices[$i]->tech)){
                                                                                echo '<td>
                                                                                        <div class="d-flex ">
                                                                                            <div>
                                                                                                 <h6>'.$B2bDevices[$i]->tech.'</h6>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>';
                                                                            }else{
                                                                            ...
                                                                            }elseif($B2bDevices[$i]->status == "finished"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                            ...
                                                                            }elseif($B2bDevices[$i]->status == "sent"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
                                                                            ...
                                                                            }elseif($B2bDevices[$i]->status == "wait4Parts"){
                                                                                echo '
                                                                                    <td>
                                                                                        <div class="d-flex ">
