        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light my-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/admin/Partners"><span class="sr-only">(current)</span> B2b Partners</a>
                </li>
                <li class="nav-item">
                  ...
                  <div class="card">
                    <div class="card-header d-flex">
                      ...
                      ?>
                              ...
                              <input placeholder="Serach Partner" id="keyword" type="text" class="form-control text-center" >
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      @foreach ($partners as $partner)
                          <h4>({{$partner->id}}) <a class="text-decoration-none" href="../admin/partner/{{$partner->id}}">{{$partner->name}}</a> </h4>
                      @endforeach
                    </div>
                </div>
        </div>
