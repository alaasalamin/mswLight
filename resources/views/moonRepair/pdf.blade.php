...
<p style="font-size: 20px;">{{$device->customerName}}</p>
<p>{{$device->customerEmail}}</p>
<p>{{$device->customerPhoneNumber}}</p>
<a>{{$device->street}} - </a>
<a>{{$device->zip}} - </a>
<a>{{$device->city}}  </a><br /><br >
<table class="GeneratedTable">
  <div style="position: absolute; right: 50px; top: 100px;">
  <?php
      $deviceId = $device->id;
      $url = "http://b2b.mswdebug.de/moonRepair/device/pdf/".$deviceId;
  ?>
