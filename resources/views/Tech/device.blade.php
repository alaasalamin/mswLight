                  ...
                  <div class="card">
                      ...
                      <form method="POST" action="{{ url('storeComment') }}">
                       ...
                       <div class="form-group row my-2">
                            ...
                            <input name="writter" type="hidden" value="{{$tech}}">
                  ...
                  <div class="card mt-2">
                      ...
                      <div class="card-body">
                            <form action="/parts" method="POST">
                                @csrf
                                <input class="form-control" placeholder="Was brauchst du ?" name="neededPart"/>
                                <input name="tech" type="hidden" value="{{$tech}}"/>
                                <input name="device" type="hidden" value="{{$deviceId}}"/>
