                                        ...
                                        <div class="col-12 grid-margin">
                                            <div class="card">
                                                <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label">Gerät*</label>
                                                                    <div class="col-sm-9">
                                                                        <select autofocus id="brand" name="brand" class="form-control form-select text-center">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <button onclick="returnDevice({{$device->id}})" class="btn btn-primary me-2 text-light">Einschicken</button>
                                                            </div>
                                                        </div>
...
<script>
    ...
    function returnDevice(id){
        window.location.href = "returnDevice/"+id;
    }
</script>
